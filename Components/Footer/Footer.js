  ...
  return (
    <footer className="bg-coolGray-100 text-coolGray-900">
      <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-col divide-coolGray-600">
        <ul className="self-center py-3 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-center">
          <li>Shop</li>
          <li>About</li>
          <li>Blog</li>
          <li>Pricing</li>
        ...
        <div className="flex flex-col justify-center pt-3 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-blue-600 hover:bg-blue-300 text-white hover:text-black transition duration-300"
            >
              <svg
