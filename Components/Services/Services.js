            ...
            <div className="max-w-xl text-left pr-16 mx-auto mb-10">
              ...
              <div className="flex">
                ...
                <a
                  href="/"
                  aria-label=""
                  className=" px-4 py-2 bg-gray-600 text-white rounded mr-4 inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800"
                >
                  Learn more
                </a>
              </div>
